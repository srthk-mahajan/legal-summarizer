...
st.title("⚖️ Legal Case Summarizer — Structured Headnotes")
st.caption("Generates Case Metadata, Facts, Issues, Arguments, Reasoning, Decision, and Key Takeaways. OCR-enabled for scanned PDFs.")
...
with col1:
    ...
    mode = st.radio("Mode:", ["Hybrid (recommended)", "Extractive only"], horizontal=True)
    detail = st.selectbox(
        "Summary length:",
        ...
        with st.spinner("Summarizing... this may take a few moments for long judgments"):
            ...
            try:
                ...
                if mode == "Hybrid (recommended)":
                    ...
                    out = summarizer.summarize_extractive_from_pdf(bytes_pdf)
